...
if ($total_items > 0) {
  ...
  //redirect too-small page numbers to the first apge
  if ($current_page < 1) {
    header("location:catalog.php?"
            . $limit_results
            ."pg=1");
  ...
  //determine offset (number of items to skip) for the current page
  //for ex : on the page 3 with 8 items per page, the offset would be 16
